function IEMdepth_anova1wayROI_X2()

% run a one-way anova for two-way X decoding accuracies
...
fnSave = [root figFolder filesep 'Dprime_anova1wayROI_X2_' voxelStr '.mat'];
